/// @description @function rousr_dissonance_handler_on_disconnected(_script_index, [_user_data])
/// @param _script_index
/// @param  [_user_data]
...
var _user_data = undefined;
if (argument_count > 1)
    _user_data    = argument[1];
      
with (global.__rousr_dissonance) {
  var handler = array_create(2);
  handler[@ 0] = _script_index; handler[@ 1] = _user_data;
  Handlers[@ EDiscordHandlers.Disconnected] = handler;
}
